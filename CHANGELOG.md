Mekatrol FlatCAM BETA (c) 2019 - by Marius Stanciu

Based on FlatCAM: 
2D Computer-Aided PCB Manufacturing by (c) 2014-2016 Juan Pablo Caram
=================================================

CHANGELOG for Mekatrol FlatCAM beta
...
- the FlatCAM projects load now in succession, no longer on threads
...
- renamed the app to Mekatrol FlatCAM in order to make a difference from FlatCAM app which follows its own path
