...
class CNCJobObject(FlatCAMObj, CNCjob):
    ...
    def gcode_header(self, comment_start_symbol=None, comment_stop_symbol=None):
        ...
        if marlin is True:
            gcode += ';Marlin(Repetier) G-code generated by Mekatrol FlatCAM v%s - Version Date:    %s\n' % \
            ...
            gcode += 'CO "HPGL code generated by Mekatrol FlatCAM v%s - Version Date:    %s' % \
                     (str(self.app.version), str(self.app.version_date)) + '";\n'
            ...
            gcode += '(G-code generated by Mekatrol FlatCAM v%s - Version Date: %s)\n' % \
                     (str(self.app.version), str(self.app.version_date)) + '\n'
            ...
            gcode += ';NCCAD9 G-code generated by Mekatrol FlatCAM v%s - Version Date:    %s\n' % \
                     (str(self.app.version), str(self.app.version_date)) + '\n'
            ...
            gcode += '%sG-code generated by Mekatrol FlatCAM v%s - Version Date: %s%s\n' % \
